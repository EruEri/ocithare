  ...
  [
    ...
    `I
      ( "To add an autogenerated password of length 20 for the website \
         $(b,site_a)",
        "$(mname) $(b,add -w site_a -m mail -c 20)"
      );
    `I ("To export your password as a json", "$(mname) $(b,export -o passwords)");
    `I
      ( "To select the password matching the name site",
        "$(mname) $(b,export -rw site)"
      );
